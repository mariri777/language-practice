...
/* ============================================================
   ...
   各ツールはこの2点だけ守れば、クリップ/マーカーUIが自動で母国語化される。

   1. ファイル名:  <学習言語>-<機能>[-<対象ユーザー>].html
                   - 日本人向け: サフィックスなし
                       例) chinese-diary.html, korean-practice.html
                   - 韓国人向け: -ko サフィックス
                       例) chinese-diary-ko.html
                   - 中国人向け: -zh サフィックス
                       例) japanese-diary-zh.html, korean-practice-zh.html

   2. <html lang>: 対象ユーザーの母国語コードを必ず指定
                   - 日本人向け → lang="ja"
                   - 韓国人向け → lang="ko"
                   - 中国人向け → lang="zh"   (簡体字UIが自動で出る)

   clips.js は <html lang> を読んで自動で ja / ko / zh に切り替える。
   端末言語 (navigator.language) は意図的に見ない。
   理由: 韓国人ユーザーが日本人向けツールを使うケースなどで、ツール本体の
        日本語解説とUIの整合性を保つため、「そのツールが誰向けか」に揃える。
   ============================================================ */
(function () {
  "use strict";
  ...
  /* ---------- i18n ----------
     <html lang> から ja / ko / zh を判定。
     未対応 lang は ja にフォールバック。 */
  const I18N = {
    ja: {
